...
def scan_ip():
    ...
    try:
        payload = {'key': 'EDCB16195A4ADD175246575E74F0FC77', 'ip': f'{ip_address}', 'format': 'json'}
        ...
        if api_result.status_code == 200:
            ...
            # result_tree.insert("", "end", values=("ISP:", isp))
            # result_tree.insert("", "end", values=("Domain:", domain))
            # result_tree.insert("", "end", values=("Net Speed:", net_speed))
            # result_tree.insert("", "end", values=("IDD Code:", idd_code))
            # result_tree.insert("", "end", values=("Area Code:", area_code))
            # result_tree.insert("", "end", values=("Weather Station Code:", weather_station_code))
            # result_tree.insert("", "end", values=("Weather Station Name:", weather_station_name))
            # result_tree.insert("", "end", values=("MCC:", mcc))
            # result_tree.insert("", "end", values=("MNC:", mnc))
            # result_tree.insert("", "end", values=("Mobile Brand:", mobile_brand))
            # result_tree.insert("", "end", values=("Elevation:", elevation))
            # result_tree.insert("", "end", values=("Usage Type:", usage_type))
            # result_tree.insert("", "end", values=("Address Type:", address_type))
            # result_tree.insert("", "end", values=("ADS Category:", ads_category))
            # result_tree.insert("", "end", values=("ADS Category Name:", ads_category_name))
            # result_tree.insert("", "end", values=("District:", district))
...
ip_label = tk.Label(top_frame, text="Ip manzil:", font=label_font)
...
scan_button = tk.Button(top_frame, text="Skaner", command=scan_ip, font=label_font, bg="blue", fg="white")
...
result_tree.heading('Value', text='Natija')
result_tree.pack()


result_tree1 = tk.Label(root, text='', font=label_font)
result_tree1.pack(pady=10, padx=10)
...
# Port scaner tugmasi
scan_button = tk.Button(but_frame, text="Port scaner", command=portscan, font=label_font)
scan_button.pack(side=tk.LEFT, padx=(10, 0))
